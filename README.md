...
*   [CLCK0622/unsplash-poster](https://github.com/CLCK0622/unsplash-poster) -
...
*   [vvbbnn00/Proj-Homo-Next](https://github.com/vvbbnn00/Proj-Homo-Next) - 使用next.js实现的“田所浩二.我爱你”站点。
...
*   [dogodo-cc/chrome-redirect-skipper](https://github.com/dogodo-cc/chrome-redirect-skipper) - A Chrome extension that bypasses redirect warning pages.
...
*   [devongovett/exif-reader](https://github.com/devongovett/exif-reader) - A small EXIF image metadata reader
...
*   [MrWillCom/rsa-cli](https://github.com/MrWillCom/rsa-cli) - A command line tool for RSA encryption and decryption.
...
*   [huggingface/huggingface\_hub](https://github.com/huggingface/huggingface_hub) - The official Python client for the Hugging Face Hub.
...
*   [matthewlarn/hyperlegible-sans](https://github.com/matthewlarn/hyperlegible-sans) - Hyperlegible Sans is an accessibility-focused, open-source evolution of Inter
...
*   [harvard-edge/cs249r\_book](https://github.com/harvard-edge/cs249r_book) - Machine Learning Systems

*   [hunvreus/devpush](https://github.com/hunvreus/devpush) - Like Vercel, but open source and for all languages.

*   [JimmyHuang037/mfsapi](https://github.com/JimmyHuang037/mfsapi) - 学生成绩查询系统
...
*   [TeacherLi07/essayhelper](https://github.com/TeacherLi07/essayhelper) - 基于嵌入模型的议论文素材检索系统
...
*   [father-bot/chatgpt\_telegram\_bot](https://github.com/father-bot/chatgpt_telegram_bot) - 💬 Telegram bot with ChatGPT & Claude Python-based, using OpenAI's API.
...
*   [privatenumber/md-pen](https://github.com/privatenumber/md-pen) - Utilities for formatting Markdown
...
*   [delucis/sweetcorn](https://github.com/delucis/sweetcorn) - 🌽 Turn smooth pixels into crunchy kernels
...
*   [pierrecomputer/theme](https://github.com/pierrecomputer/theme) - Custom theme for VS Code, Zed, and Shiki projects. Built with Pierre's color scheme.
...
*   [olcchi/Sign](https://github.com/olcchi/Sign) - Digital Cheering Sign Generator
...
*   [subframe7536/vscode-theme-maple](https://github.com/subframe7536/vscode-theme-maple) - A colorful VSCode theme, support light and dark mode, with medium brightness and low saturation.
...
*   [unix/secret](https://github.com/unix/secret) - Client-side encrypted sharing for short-lived secrets.
...
*   [StickyHomeworks2/StickyHomeworks2](https://github.com/StickyHomeworks2/StickyHomeworks2) - 一款支持富文本的桌面作业贴工具。
...
*   [bezzad/Downloader](https://github.com/bezzad/Downloader) - Fast, cross-platform and reliable multipart downloader with asynchronous progress events for .NET applications. If you want Downloader Desktop application see this: https://github.com/bezzad/downloader.desktop
...
*   [hacker-frok/LiteLoaderQQNT-Plugin-Brevity-btn](https://github.com/hacker-frok/LiteLoaderQQNT-Plugin-Brevity-btn) - 本插件隐藏QQNT侧栏部位，并在顶部添加快速显示/隐藏按钮，带来纯纯的聊天模式
...
*   [stephancasas/finder-emoji](https://github.com/stephancasas/finder-emoji) - Add some Finder flavor to your Slack workspace
...
*   [onevcat/Prowl](https://github.com/onevcat/Prowl) - native macOS codings agent orchestrator
...
*   [aeilot/stay-away-from-my-screen](https://github.com/aeilot/stay-away-from-my-screen) - The instant digital "Do Not Touch" sign for your Mac. Stop fingerprints and protect your expensive display with one keystroke.
...
*   [CLCK0622/Eventual](https://github.com/CLCK0622/Eventual) - Track what matters. Past, present, and future.
...
*   [mayoff/RectangleContour](https://github.com/mayoff/RectangleContour) - Find the union of a set of axis-aligned rectangles
...
*   [orilights/hoyoplay-background](https://github.com/orilights/hoyoplay-background) - 米哈游启动器背景收集
...
*   [chr56/Phonograph\_Plus](https://github.com/chr56/Phonograph_Plus) - Yet another independent fork of kabouzeid/Phonograph -- a  revived classic material designed music player for Android
...
*   [stryder-dev/flutter\_platform\_widgets](https://github.com/stryder-dev/flutter_platform_widgets) - Target the specific design of Material for Android and Cupertino for iOS widgets through a common set of Platform aware widgets
...
*   [bdlukaa/fluent\_ui](https://github.com/bdlukaa/fluent_ui) - Microsoft's WinUI3 in Flutter.
...
*   [HttpRafa/modflared](https://github.com/HttpRafa/modflared) - Automatically connects you to a Cloudflare tunnel without having to install cloudflared separately.
...
*   [Additional-Mods/additionaladditions](https://github.com/Additional-Mods/additionaladditions) - A mod that expands on parts of Minecraft that feel incomplete, with additions that feel like they should already be part of vanilla.
...
*   [philipbelesky/inter-ui](https://github.com/philipbelesky/inter-ui) - A npm package for distributing the Inter font family created by Rasmus Andersson.
...
*   [evvoon/stopwatch](https://github.com/evvoon/stopwatch) -
...
*   [ttytm/logseq-allday-theme](https://github.com/ttytm/logseq-allday-theme) - A clean productivity theme. Styled for high readability and minimal eye strain.

*   [mimeku/hexo-theme-cupertino](https://github.com/mimeku/hexo-theme-cupertino) - Update hexo-theme-cupertino
...
*   [yujqiao/typography](https://github.com/yujqiao/typography) - A Hexo theme focused on clean format and elegant reading experience.
...
*   [saveweb/review-2022](https://github.com/saveweb/review-2022) - 饿您饿饿年，你吃年终总结了馍？
...
*   [ryanccn/modernflux](https://github.com/ryanccn/modernflux) - A modern look and feel for Miniflux
...
*   [Code1ce/2024-shzk-Math](https://github.com/Code1ce/2024-shzk-Math) - 2024年上海市上海市初中学业水平考试 数学试卷
...
*   [aeilot/.vimrc.d](https://github.com/aeilot/.vimrc.d) - My Vim Configuration
